...
const quranLocale = {
	en: { title: 'Quran', reciter: 'Reciter', listen: 'Listen', pause: 'Pause', next: 'Next', previous: 'Previous', jumpTo: 'Jump to surah…', markCompleted: 'Mark completed', completed: 'Completed', surah: 'Surah', progress: 'Khatm progress', congrats: "Congratulations on your completion of the Holy Qur'an.", reset: 'Restart', autoContinue: 'Auto-continue next surah', sajda: 'Sajdah', sajdaTip: 'This surah contains a verse of prostration (ayat as-sajdah)', favorite: 'Favorite' },
	ar: { title: 'القرآن', reciter: 'القارئ', listen: 'استماع', pause: 'إيقاف', next: 'التالي', previous: 'السابق', jumpTo: 'انتقل إلى سورة…', markCompleted: 'تحديد كمكتمل', completed: 'مكتمل', surah: 'سورة', progress: 'الختمة', congrats: 'تهانينا على ختمك القرآن الكريم.', reset: 'ابدأ من جديد', autoContinue: 'الاستمرار إلى السورة التالية', sajda: 'سجدة', sajdaTip: 'تحتوي هذه السورة على آية سجدة', favorite: 'المفضلة' },
	tr: { title: "Kur'an", reciter: 'Okuyan', listen: 'Dinle', pause: 'Duraklat', next: 'Sonraki', previous: 'Önceki', jumpTo: 'Sûreye git…', markCompleted: 'Tamamlandı işaretle', completed: 'Tamamlandı', surah: 'Sûre', progress: 'Hatim', congrats: "Kur'an-ı Kerim'i hatmettiğiniz için tebrikler.", reset: 'Yeniden başla', autoContinue: 'Sonraki sûre ile devam et', sajda: 'Secde', sajdaTip: 'Bu surede tilavet secdesi âyeti vardır', favorite: 'Favori' },
